...
/*   Updated: 2021/04/14 18:43:48 by bde-luca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "parser.h"

void	check_num_of_commas(t_data *p, char *line)
{
	int	num_of_commas;
	int	i;
...
void	check_color_error_1(char to_check, t_data *p, char *line, int *i)
{
	if (to_check == 'F')
	{
...
int	find_color(t_data *p, char *line, char to_check)
{
	...
	return (ft_color_to_int(color.r, color.g, color.b));
}
